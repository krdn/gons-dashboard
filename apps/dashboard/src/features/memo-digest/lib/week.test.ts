...
describe("enumerateMissingWeekEnds", () => {
  ...
  test("maxWeeks 상한 — 오래된 순 컷 (최신 우선 컷은 커서가 구멍을 건너뛰어 영구 스킵)", () => {
  ...
  test("긴 공백은 여러 실행에 걸쳐 소진 — 배치 처리 후 커서가 전진하면 다음 4주", () => {
    // 첫 실행이 1/11~2/1을 생성 → 커서(getLatestDigest)=2/1 → 다음 실행은 그 다음 4주.
    expect(enumerateMissingWeekEnds("2026-02-01", "2026-07-12", 4)).toEqual([
      "2026-02-08",
      "2026-02-15",
      "2026-02-22",
      "2026-03-01",
