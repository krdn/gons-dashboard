    ...
    <section className="flex flex-col gap-3 rounded-xl border border-[var(--color-hairline)] bg-white p-3 shadow-sm sm:flex-row sm:items-center sm:gap-2">
      <div className="flex flex-1 items-center gap-2">
        <label className="relative flex flex-1 items-center">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[var(--color-hairline)] bg-white py-2 pl-8 pr-3 text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-subtle)] focus-visible:border-[var(--color-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)]"
          />
        </label>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--color-hairline)] bg-white px-3 py-2 text-xs font-medium text-[var(--color-text-muted)] hover:bg-[var(--color-surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={14}
        ...
        <button
          ...
          aria-label="도움말 열기"
          className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-[var(--color-hairline)] bg-white text-sm font-semibold text-[var(--color-text-muted)] hover:bg-[var(--color-surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)]"
        >
          ?
        </button>
      </div>
